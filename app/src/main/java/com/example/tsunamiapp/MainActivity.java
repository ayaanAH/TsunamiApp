...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateUi(Event earthquake)
    {
        ...
        countTextView.setText(earthquake.count);
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            try {
                ...
                JSONObject metadataObj = baseJsonResponse.getJSONObject("metadata");
                ...
                if (featureArray.length() > 0) {
                    ...
                    String countDataString = metadataObj.getString("count");
                    ...
                    return new Event(countDataString, title, time, tsunamiAlert);
                }
